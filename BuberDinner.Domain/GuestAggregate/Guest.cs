...
{
    private readonly List<GuestId> _upcomingDinnerIds = new();
    private readonly List<GuestId> _pastDinnerIds = new();
    private readonly List<GuestId> _pendingDinnerIds = new();
    ...
    public IReadOnlyList<GuestId> UpcomingDinnerIds => _upcomingDinnerIds.AsReadOnly();
    public IReadOnlyList<GuestId> PastDinnerIds => _pastDinnerIds.AsReadOnly();
    public IReadOnlyList<GuestId> PendingDinnerIds => _pendingDinnerIds.AsReadOnly();
